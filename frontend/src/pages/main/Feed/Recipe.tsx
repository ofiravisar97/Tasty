...
const Recipe = ({ recipe }: Props) => {
  return (
    <article className="bg-white h-fit mt-4 rounded-md shadow-md flex flex-col">
      ...
      <section className="flex px-4 py-2 gap-2 w-full">
        <p className="font-semibold">{recipe.likesCount} likes</p>
        <p className="ml-auto">{moment(recipe.createdAt).fromNow()}</p>
      </section>
